...
- `base/base-utility-service-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'base-utility-service-java-sev'
- `base/csi-personalization-service-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-personalization-service-java-sev'
...
- `bloodbank/bb-bloodbankgui`: Rule 3: Updated patchesJson6902 Deployment target name to 'bb-bloodbankgui'
- `bloodbank/bb-donation-srv`: Rule 3: Updated patchesJson6902 Deployment target name to 'bb-donation-srv'
- `bloodbank/csi-blood-transfusion-java`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-blood-transfusion-java'
- `bloodbank/csi-net-bb-mgt-srv`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-net-bb-mgt-srv'
- `ehr/csi-ehr-com-ip-dashboardwidget-dotnet-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-com-ip-dashboardwidget-dotnet-sev'
- `ehr/csi-ehr-com-opd-master-dotnet-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-com-opd-master-dotnet-sev'
- `ehr/csi-ehr-common-scheduler-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-common-scheduler-java-sev'
- `ehr/csi-ehr-config-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-config-java-sev'
- `ehr/csi-ehr-ic-bundle-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-ic-bundle-java-sev'
- `ehr/csi-ehr-ic-dashboard-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-ic-dashboard-java-sev'
- `ehr/csi-ehr-ldr-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-ldr-java-sev'
- `ehr/csi-ehr-listener-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-listener-java-sev'
- `ehr/csi-ehr-opd-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-opd-java-sev'
- `ehr/csi-ehr-opd-patient-pomr-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-opd-patient-pomr-java-sev'
- `ehr/csi-ehr-or-anesthesia-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-or-anesthesia-java-sev'
- `ehr/csi-ehr-or-book-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-or-book-java-sev'
- `ehr/csi-ehr-or-booking-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-or-booking-java-sev'
- `ehr/csi-ehr-specialized-clinic-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-specialized-clinic-java-sev'
- `ehr/csi-ehr-template-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-template-java-sev'
...
- `er/csi-ehr-er-functions-dotnet-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ehr-er-functions-dotnet-sev'
- `hhc/hhc-service`: Rule 3: Updated patchesJson6902 Deployment target name to 'hhc-service'
- `hhc/hhc-ui`: Rule 3: Updated patchesJson6902 Deployment target name to 'hhc-ui'
- `him/csi-health-information-srv`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-health-information-srv'
- `lab/lab-labgui`: Rule 3: Updated patchesJson6902 Deployment target name to 'lab-labgui'
- `lab/lab-labmgt-srv`: Rule 3: Updated patchesJson6902 Deployment target name to 'lab-labmgt-srv'
- `lab/lab-scheduled`: Rule 3: Updated patchesJson6902 Deployment target name to 'lab-scheduled'
- `lab/lab-vidaptor-integration`: Rule 3: Updated patchesJson6902 Deployment target name to 'lab-vidaptor-integration'
- `notification/csi-net-base-email`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-net-base-email'
- `notification/csi-net-base-message-templates`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-net-base-message-templates'
- `notification/csi-net-base-notifications`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-net-base-notifications'
- `notification/csi-net-base-notifications-query`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-net-base-notifications-query'
- `notification/csi-net-base-sms`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-net-base-sms'
- `pharmacy/csi-net-base-integrations-medispan`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-net-base-integrations-medispan'
- `pharmacy/phr-pharmacygui`: Rule 3: Updated patchesJson6902 Deployment target name to 'phr-pharmacygui'
- `reporting/csi-rf-reportingservice`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-rf-reportingservice'
- `reporting/report-studio-ui`: Rule 3: Updated patchesJson6902 Deployment target name to 'report-studio-ui'
- `rms/csi-ds-dental-core-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-ds-dental-core-java-sev'
- `rms/csi-pms-adt-request-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-pms-adt-request-java-sev'
...
- `rms/csi-rms-rules-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-rms-rules-java-sev'
...
- `base/csi-uif-settings`: Rule 4: patch-hpa.yaml - updated name to 'csi-uif-settings'
- `billing/csi-bm-approval-java-service`: Rule 4: patch-hpa.yaml - updated name to 'csi-bm-approval-java-service'
- `billing/csi-bm-approval-java-service`: Rule 4: patch-pod.yaml - updated name to 'csi-bm-approval-java-service'
...
- `bloodbank/bb-donation-srv`: Rule 4: hpa.yaml - updated name to 'bb-donation-srv'
- `bloodbank/bb-donation-srv`: Rule 4: patch-pod.yaml - updated name to 'bb-donation-srv'
- `bloodbank/csi-blood-transfusion-java`: Rule 4: hpa.yaml - updated name to 'csi-blood-transfusion-java'
...
- `ehr/csi-ehr-com-ip-discharge-dotnet-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-com-ip-discharge-dotnet-sev'
- `ehr/csi-ehr-com-ip-discharge-dotnet-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-com-ip-discharge-dotnet-sev'
- `ehr/csi-ehr-com-opd-master-dotnet-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-com-opd-master-dotnet-sev'
- `ehr/csi-ehr-com-opd-master-dotnet-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-com-opd-master-dotnet-sev'
- `ehr/csi-ehr-com-opd-patient-dotnet-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-com-opd-patient-dotnet-sev'
- `ehr/csi-ehr-com-opd-patient-dotnet-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-com-opd-patient-dotnet-sev'
- `ehr/csi-ehr-common-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-common-java-sev'
...
- `ehr/csi-ehr-config-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-config-java-sev'
- `ehr/csi-ehr-config-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-config-java-sev'
- `ehr/csi-ehr-ic-bundle-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-ic-bundle-java-sev'
- `ehr/csi-ehr-ic-dashboard-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-ic-dashboard-java-sev'
- `ehr/csi-ehr-ic-dashboard-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-ic-dashboard-java-sev'
- `ehr/csi-ehr-initialassessment-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-initialassessment-java-sev'
- `ehr/csi-ehr-ip-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-ip-java-sev'
- `ehr/csi-ehr-ip-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-ip-java-sev'
- `ehr/csi-ehr-ldr-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-ldr-java-sev'
- `ehr/csi-ehr-ldr-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-ldr-java-sev'
- `ehr/csi-ehr-listener-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-listener-java-sev'
- `ehr/csi-ehr-listener-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-listener-java-sev'
- `ehr/csi-ehr-opd-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-opd-java-sev'
- `ehr/csi-ehr-opd-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-opd-java-sev'
- `ehr/csi-ehr-opd-patient-pomr-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-opd-patient-pomr-java-sev'
- `ehr/csi-ehr-opd-patient-pomr-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-opd-patient-pomr-java-sev'
- `ehr/csi-ehr-opd-ui`: Rule 4: hpa.yaml - updated name to 'csi-ehr-opd-ui'
- `ehr/csi-ehr-or-anesthesia-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-or-anesthesia-java-sev'
- `ehr/csi-ehr-or-anesthesia-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-or-anesthesia-java-sev'
- `ehr/csi-ehr-or-book-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-or-book-java-sev'
- `ehr/csi-ehr-or-book-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-or-book-java-sev'
- `ehr/csi-ehr-or-booking-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-or-booking-java-sev'
- `ehr/csi-ehr-or-booking-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-or-booking-java-sev'
- `ehr/csi-ehr-specialized-clinic-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-specialized-clinic-java-sev'
- `ehr/csi-ehr-specialized-clinic-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-specialized-clinic-java-sev'
- `ehr/csi-ehr-template-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-template-java-sev'
...
- `empi/csi-empi-patient-registration-srv`: Rule 4: hpa.yaml - updated name to 'csi-empi-patient-registration-srv'
...
- `er/csi-ehr-er-functions-dotnet-sev`: Rule 4: hpa.yaml - updated name to 'csi-ehr-er-functions-dotnet-sev'
- `er/csi-ehr-er-functions-dotnet-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ehr-er-functions-dotnet-sev'
- `hhc/hhc-service`: Rule 4: hpa.yaml - updated name to 'hhc-service'
- `him/csi-health-information-srv`: Rule 4: hpa.yaml - updated name to 'csi-health-information-srv'
- `lab/lab-labgui`: Rule 4: patch-pod.yaml - updated name to 'lab-labgui'
- `lab/lab-labmgt-srv`: Rule 4: hpa.yaml - updated name to 'lab-labmgt-srv'
...
- `notification/csi-net-base-message-templates`: Rule 4: patch-hpa.yaml - updated name to 'csi-net-base-message-templates'
- `notification/csi-net-base-message-templates`: Rule 4: patch-pod.yaml - updated name to 'csi-net-base-message-templates'
- `notification/csi-net-base-notifications`: Rule 4: hpa.yaml - updated name to 'csi-net-base-notifications'
- `notification/csi-net-base-notifications-query`: Rule 4: hpa.yaml - updated name to 'csi-net-base-notifications-query'
...
- `renal/ren-hemodialysis-srv`: Rule 4: hpa.yaml - updated name to 'ren-hemodialysis-srv'
...
- `rms/csi-ds-dental-core-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-ds-dental-core-java-sev'
- `rms/csi-ds-dental-core-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-ds-dental-core-java-sev'
- `rms/csi-pms-adt-request-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-pms-adt-request-java-sev'
- `rms/csi-pms-adt-request-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-pms-adt-request-java-sev'
- `rms/csi-pms-adt-ui`: Rule 4: patch-pod.yaml - updated name to 'csi-pms-adt-ui'
- `rms/csi-rms-masterdata-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-rms-masterdata-java-sev'
- `rms/csi-rms-masterdata-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-rms-masterdata-java-sev'
- `rms/csi-rms-morgue-java-service`: Rule 4: patch-pod.yaml - updated name to 'csi-rms-morgue-java-service'
- `rms/csi-rms-reservation-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-rms-reservation-java-sev'
- `rms/csi-rms-reservation-java-sev`: Rule 4: patch-pod.yaml - updated name to 'csi-rms-reservation-java-sev'
- `rms/csi-rms-resource-registry-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-rms-resource-registry-java-sev'
