...
- `ehr/ehr-ic-ui`: Rule 4: patch-hpa.yaml - updated name to 'ehr-ic-ui'
...
- `lab/lab-labgui`: Rule 4: patch-hpa.yaml - updated name to 'lab-labgui'
...
- `lab/lab-vidaptor-integration`: Rule 4: patch-hpa.yaml - updated name to 'lab-vidaptor-integration'
...
- `notification/csi-net-base-sms`: Rule 4: patch-hpa.yaml - updated name to 'csi-net-base-sms'
- `notification/csi-net-base-sms`: Rule 4: patch-pod.yaml - updated name to 'csi-net-base-sms'
- `pharmacy/csi-net-base-integrations-medispan`: Rule 4: patch-hpa.yaml - updated name to 'csi-net-base-integrations-medispan'
...
- `rms/csi-rms-morgue-java-service`: Rule 4: patch-hpa.yaml - updated name to 'csi-rms-morgue-java-service'
