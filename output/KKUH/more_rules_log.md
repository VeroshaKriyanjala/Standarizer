...
- `rms/csi-rms-masterdata-java-sev`: Rule 3: Updated patchesJson6902 Deployment target name to 'csi-rms-masterdata-java-sev'
...
- `base/base-utility-service-java-sev`: Rule 4: hpa.yaml - updated name to 'base-utility-service-java-sev'
- `base/base-utility-service-java-sev`: Rule 4: patch-pod.yaml - updated name to 'base-utility-service-java-sev'
- `base/csi-personalization-service-java-sev`: Rule 4: hpa.yaml - updated name to 'csi-personalization-service-java-sev'
...
- `base/csi-uif-settings`: Rule 4: hpa.yaml - updated name to 'csi-uif-settings'
- `billing/csi-bm-approval-java-service`: Rule 4: hpa.yaml - updated name to 'csi-bm-approval-java-service'
...
- `bloodbank/csi-net-bb-mgt-srv`: Rule 4: patch-hpa.yaml - updated name to 'csi-net-bb-mgt-srv'
...
- `ehr/csi-workflow-automation-service-java-sev`: Rule 4: patch-hpa.yaml - updated name to 'csi-workflow-automation-service-java-sev'
...
- `lab/lab-scheduled`: Rule 4: hpa.yaml - updated name to 'lab-scheduled'
...
- `reporting/csi-rf-reportingservice`: Rule 4: hpa.yaml - updated name to 'csi-rf-reportingservice'
